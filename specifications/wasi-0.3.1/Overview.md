# WASI Specification v0.3.1

This is version 0.3.1 of the WASI specification, based on the [WebAssembly
Component Model][cm].
...
- [wasi:random@0.3.1](https://github.com/WebAssembly/WASI/pkgs/container/wasi%2Frandom?tag=0.3.1)
- [wasi:clocks@0.3.1](https://github.com/WebAssembly/WASI/pkgs/container/wasi%2Fclocks?tag=0.3.1)
- [wasi:sockets@0.3.1](https://github.com/WebAssembly/WASI/pkgs/container/wasi%2Fsockets?tag=0.3.1)
- [wasi:filesystem@0.3.1](https://github.com/WebAssembly/WASI/pkgs/container/wasi%2Ffilesystem?tag=0.3.1)
- [wasi:cli@0.3.1](https://github.com/WebAssembly/WASI/pkgs/container/wasi%2Fcli?tag=0.3.1)
- [wasi:http@0.3.1](https://github.com/WebAssembly/WASI/pkgs/container/wasi%2Fhttp?tag=0.3.1)
...
| 🗺️ | The `map<K, V>` type | 0.3.1 |
| 🏷️ | `implements` and `external-id` annotations on plain-named interface imports and exports | 0.3.1 |
